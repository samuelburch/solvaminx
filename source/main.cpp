...
vec3 colors[12] = {{0.968, 0.900, 0.111},  // yellow
...
typedef struct face {
  ...
  void cc() {
    ...
    // 					 adjacent[z - 1]->getedge(edgemap[f * 5
    // + (z
    // - 1)])); z = 3; adjacent[z]->setedge(edgemap[f * 5 + z],
    // adjacent[z - 1]->getedge(edgemap[f * 5 + (z - 1)])); z = 2;
    // adjacent[z]->setedge(edgemap[f * 5 + z],
    // 					 adjacent[z - 1]->getedge(edgemap[f * 5
    // + (z
    // - 1)])); z = 1; adjacent[z]->setedge(edgemap[f * 5 + z],
